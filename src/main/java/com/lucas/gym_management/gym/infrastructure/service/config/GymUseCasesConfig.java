...
public class GymUseCasesConfig {
    ...
    @Bean
    public UpdateGymUseCase updateGymUseCase(GymRepository gymRepository, UserGateway userGateway){
        return new UpdateGymUseCaseImpl(gymRepository, userGateway);
    }
    ...
    @Bean
    public AddMemberUseCase addMemberUseCase(GymRepository gymRepository, UserGateway userGateway){
        return new AddMemberUseCaseImpl(gymRepository, userGateway);
    }
